...
document.addEventListener("DOMContentLoaded", function (e) {
  ...
  bgCircle.addEventListener("animationend", function (e) {
...
if (window.location.href.indexOf("about") > -1) {
  toBlack.addEventListener("mouseover", function (e) {
    cursor.style.borderColor = "black";
  });
  toBlack.addEventListener("mouseleave", function (e) {
...
cv.addEventListener("click", (e) => {
  window.open("./img/projects/Juan_Ramirez.pdf", "_blank");
});
